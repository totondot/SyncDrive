...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Setup Feature 15 (Data Export)
        // Note: We pass the tripHistoryController into it so it can read the logs!
        ...
        // Setup Feature 17 (Pre-ride Safety Checklist)
        ...
        // Setup Feature 18 (Past Service History)
        ...
        // Mock historical data so the log isn't empty
        val thirtyDaysAgo = System.currentTimeMillis() - (86400000L * 30)
        val ninetyDaysAgo = System.currentTimeMillis() - (86400000L * 90)

        serviceLogController.addRecord(
            "LiDAR Array Recalibration",
            48500.0,
            "Routine sensor alignment. All lasers nominal.",
            thirtyDaysAgo
        )
        serviceLogController.addRecord(
            "Tire Rotation & Alignment",
            42000.0,
            "Rotated all 4 tires. Adjusted front-right camber.",
            ninetyDaysAgo
        )

        // Setup Feature 19 (Speed & Geofence Restrictions)
